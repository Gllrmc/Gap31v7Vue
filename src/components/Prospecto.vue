    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                ...
                <v-toolbar-title>Prospectos en Tratamiento</v-toolbar-title>
                <v-snackbar
                    v-model="snackbar"
                    :timeout="timeout"
                    right
        ...
        data(){
            return {
                ...
                headers: [
                    ...
                    { text: '%GtsFijo', value: 'porgastosfijo', sortable: true },
                    { text: '%Gan', value: 'porganancia', sortable: true },
                    { text: '%FeeDir', value: 'porfeedireccion', sortable: true },
                    { text: '%OtrGts', value: 'porotrosgastos', sortable: true },
                    { text: '%CtoFin', value: 'porcostofinanciero', sortable: true },
                    { text: '%Imp&Com', value: 'porimpuestoycomision', sortable: true },
                    { text: 'U$D Venta', value: 'impventa', sortable: true },
                    { text: 'U$S CMarg.', value: 'impcontribucion', sortable: true },
                    { text: '%CMarg.', value: 'porcontribucion', sortable: true },
                    { text: 'Tipo de Proyecto', value: 'tipoproy', sortable: true },
