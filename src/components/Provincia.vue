        ...
        data(){
            return {
                ...
                headers: [
                    ...
                    { text: 'Id', value: 'idprovincia', sortable: true },
        ...
        methods:{
            crearPDF(){
                ...
                this.provincias.map(function(x){
                    rows.push({idprovincia:x.idprovincia,provincia:x.provincia,activo:x.activo ? "Activo" : "Inactivo"});
                });
            ...
            validar(){
                ...
                if (this.provincia.length<3 || this.provincia.length>50){
            ...
            activarDesactivarMostrar(accion,item){
                this.adModal=1;
                this.adNombre=item.provincia;
                this.adId=item.idprovincia;                
                if (accion==1){
                    this.adAccion=1;
                }
                else if (accion==2){
