    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                <v-toolbar-title>Control DxD Shooting</v-toolbar-title>
                <v-snackbar
                    v-model="snackbar"
                    :timeout="timeout"
                    right
                    ...
                    <v-btn color="primary" dark class="mb-2" @click="crearXLS()">Exportar XLS</v-btn>
                        ...
                        <v-data-table
                            ...
                            <template v-if="validateAccess(props.item.iditem)" slot="items" slot-scope="props">
                                ...
                                <td>{{ props.item.hsbase }}</td>
                                <td>{{ props.item.horas }}</td>
                                <td>{{ props.item.hsext }}</td>
                                <td>{{ props.item.hseng }}</td>
                                <td>{{ props.item.hsnoc }}</td>
                                <td>{{ props.item.impbruto }}</td>
                                <td>{{ props.item.impret }}</td>
                                <td>{{ props.item.impsac }}</td>
                                <td>{{ props.item.impvac }}</td>
                                <td>{{ props.item.impsacv }}</td>
                                <td>{{ props.item.impneto }}</td>
                                <td>{{ props.item.impcontr }}</td>
    ...
    export default {
            data: () => {
                ...
                headersDetalle: [
                    ...
                    { text: 'Hs.Base', value: 'hsbase', sortable: true },
                    { text: 'Hs.Normal', value: 'horas', sortable: true },
                    { text: 'Hs.Extra', value: 'hsext', sortable: true },
                    { text: 'Hs.Enganche', value: 'hseng', sortable: true},
                    { text: 'Hs.Nocturna', value: 'hsnoc', sortable: true },
                    { text: 'Imp.Bruto', value: 'impbruto', sortable: true },
                    { text: 'Imp.Retencion', value: 'impret', sortable: true },
                    { text: 'Imp.SAC', value: 'impsac', sortable: true },
                    { text: 'Imp.Vac.', value: 'impvac', sortable: true },
                    { text: 'Imp.S/Vac.', value: 'impsacv', sortable: true },
                    { text: 'Imp.Neto', value: 'impneto', sortable: true },
                    { text: 'Imp.Contr.', value: 'impcontr', sortable: true },
            ...
            listarDetail(){
                ...
                let configuracion= {headers : header};      
                //console.log(configuracion);
                axios.get('api/Realdxds/Controlshoot2date/'+this.idproyecto,configuracion).then(function(response){
                    //console.log(response);
