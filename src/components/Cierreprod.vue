    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                ...
                <v-toolbar-title>Cierre de Produccion</v-toolbar-title>
                <v-snackbar
                    v-model="snackbar"
                    :timeout="timeout"
                    right
                        ...
                        <v-container grid-list-md>
                            <v-layout wrap>
                                <v-flex xs12 sm12 md12>
                                    <input type="checkbox" id="prod" v-model="cierreprod">
                                    <label for="prod"> Cerre de Producción?</label>
                                </v-flex>
                            </v-layout>
                        </v-container>
                        </v-card-text>
        ...
        methods:{
            crearPDF(){
                var columns = [
                    ...
                    {title: "Tipo de producción", dataKey: "tipoprod"},
            ...
            validar(){
                ...
                me.garantias=[];
                if (me.cierreprod){
                    // Control de cheques en Garantia
                    me.garantias = me.allgarantias.filter( i => i.idproyecto === me.idproyecto);
                    if (me.garantias.length){
                        me.snacktext = "Existe(n) "+ this.garantias.length +" Garantia(s) pendiente(s) de recupero.";
                        me.snackbar = true;
                        me.cierreprod = false;
                        me.valida=true;
                    }
